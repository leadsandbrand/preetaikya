...
import TestimonialsCard22 from "@/components/shared/cards/TestimonialsCard22";
import Ratings1 from "@/components/shared/ratings/Ratings1";
import getTestimonials from "@/libs/getTestimonials";
import { Autoplay, Navigation, Pagination } from "swiper/modules";
import { Swiper, SwiperSlide } from "swiper/react";

const Testimonials22 = ({ type }) => {
	const testimonials = getTestimonials()?.slice(0, 1);
					...
					<div className={`col-lg-6 ${type === 2 ? "order-lg-2" : ""}`}>
						...
						>
							<div className="testimonial-img">
								<img
									data-speed=".8"
									src="/images/testimonial/slumschool.jpg"
									alt=""
								/>
								...
								{testimonials?.length
									? testimonials?.map((testimonial, idx) => (
											<SwiperSlide key={idx}>
                                                ...
                                                <TestimonialsCard22 testimonial={testimonial} />
