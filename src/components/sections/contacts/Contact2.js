					...
					<div className="col-lg-6">
						<div className="global-map wow fadeInUp" data-wow-delay=".3s">
							<div className="global-map-img">
								<img src="/images/bg/WM.svg" alt="Image" />
								<div className="location-indicator loc-1">
									<div className="location-tooltip">
										<span>Head office:</span>
										<p>A -163, Mahakali Society, Trilanga, Bhopal 462016</p>
										<Link href="tel:10095447818">P: +91 9630539366</Link>
										<Link href=" connect@preetaikya.org">
										connect@preetaikya.org
										</Link>
									</div>
								</div>
