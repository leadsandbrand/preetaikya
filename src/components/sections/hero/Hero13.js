...
const Hero13 = () => {
	return (
		<section className="tj-banner-section-2 section-gap-x">
					...
					<div className="col-12">
						<div className="sec-heading style-4 text-center">
							<span className="sub-title wow fadeInUp" data-wow-delay=".3s">
								<i className="tji-box"></i>Memory Care
							</span>
           ...
           <p>Aikya ManasMitraa is our specialized memory care initiative dedicated to seniors experiencing cognitive decline and dementia.
			<br/>
		   ...
		   <br/>
           For more information, visit: www.elderfirst.co.in
