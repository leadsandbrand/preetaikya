					...
					<div className="col-12">
						<div className="sec-heading style-4 text-center">
							<span className="sub-title wow fadeInUp" data-wow-delay=".3s">
								<i className="tji-box"></i>Group Ventures
							</span>
					...
					<div className="row">
						...
						<div className="banner-content-2">
							<span className="sub-title wow fadeInUp" data-wow-delay=".2s">
								 Elder First : Elevating Senior Living
							</span> 
           <p>Dignified aging is not a luxury. It is a right.
			<br/>


		   Through assisted living homes, healthcare coordination, day care, and community-based elder support, we create safe, joyful environments where seniors are respected, engaged, and celebrated.
		   <br/>
		   Growing older should not mean growing invisible.
		   <br/>
		   It should mean growing freer.
...
.</p>
					...
					<div className="col-lg-7">
						<div className="banner-img-area wow fadeInUp" data-wow-delay=".3s">
							...
							<Image
  src="/images/hero/gallery-md4.jpg"
  alt=""
  width={1000}
  height={600}
  style={{	
