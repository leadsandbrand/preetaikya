	...
	return (
		<div className="blog-item wow fadeInUp" data-wow-delay=".3s">
			...
			<div className="blog-content">
				...
				<p>A life of humility, wisdom, and integrity. Rising from modest beginnings to corporate leadership, his journey reminds us that true success lies not in wealth — but in values. His quiet strength shapes our moral compass.</p>
			</div>
		</div>
	);
};
